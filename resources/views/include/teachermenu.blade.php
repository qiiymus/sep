...
<html lang="en">
  ...
  <body>
    <div class="d-flex flex-column flex-shrink-0" style="width: 3.5rem; background-color: #b0d9e2; height: 100vh; ; position: fixed;">
      ...
      <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
        ...
        <li>
          <a href="{{ route('TeacherViewTT') }}" class="nav-link py-3 border-bottom" title="Timetable" data-bs-toggle="tooltip" data-bs-placement="right">
        ...
        <li>
          <a href="{{ route('indexteacher') }}" class="nav-link py-3 border-bottom" title="Bulletin" data-bs-toggle="tooltip" data-bs-placement="right">
